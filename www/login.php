...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="index.php"> <img src="admin/img/comilones_logo.png" alt="logo de comilones"></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col">
                            <a data-toggle="modal" data-target="#staticBackdrop" class=" btn btn-primary btn-block text-white text-bold">Acceder</a>
                        </div>
